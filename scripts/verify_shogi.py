"""Verify shogi: regenerate March 2026 settlement, diff against existing file."""
...
FEB_TEMPLATE = r"Y:\_★20170701作業用\【エデュプラス請求書】\スマイル将棋清算書\スマイル将棋売上管理表_202602月分.xlsx"
SOURCE_XLSM  = r"Y:\_★20170701作業用\【エデュプラス請求書】\【業者請求書】エクセルbackup\2026年2月17日送信分\2026年2月17日送信.xlsm"
EXPECTED_MAR = r"Y:\_★20170701作業用\【エデュプラス請求書】\スマイル将棋清算書\スマイル将棋売上管理表_202603月分.xlsx"

OUTPUT_DIR = Path(r"C:\tmp\margin_explore")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
GENERATED = str(OUTPUT_DIR / "generated_shogi_202603月分.xlsx")
...
def main():
    print("=" * 80)
    print("Regenerating shogi March 2026 settlement from Feb template...")
    print("=" * 80)
    run(
        service="shogi",
        source=SOURCE_XLSM,
